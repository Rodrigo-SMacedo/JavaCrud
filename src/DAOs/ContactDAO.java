...
public class ContactDAO {
    ...
    public static void createContact(Contact contact) {
        ...
        if (contact.getPhone_2() == null) {
            sql = "INSERT INTO contact (responsible, email, phone_1) VALUES ('" + contact.getResponsible() + "', " + "'"
                    + contact.getEmail() + "', " + "'" + contact.getPhone_1() + "');";
        } else {
            sql = "INSERT INTO contact (responsible, email, phone_1, phone_2) VALUES ('" + contact.getResponsible()
                    + "', " + "'" + contact.getEmail() + "', " + "'" + contact.getPhone_1() + "', " + "'"
                    + contact.getPhone_2() + "');";
        }
    ...
    public static void updateContact(Contact contact) {
        ...
        if (contact.getPhone_2() == null) {
            sql = "UPDATE contact " + "SET responsible = '" + contact.getResponsible() + "', " + "email = '"
                    + contact.getEmail() + "', " + "phone_1 = '" + contact.getPhone_1() + "' " + "WHERE contact_id = "
                    + contact.getContact_id() + "";
        } else {
            sql = "UPDATE contact " + "SET responsible = '" + contact.getResponsible() + "', " + "email = '"
                    + contact.getEmail() + "', " + "phone_1 = '" + contact.getPhone_1() + "', " + "phone_2 = '"
                    + contact.getPhone_2() + "' " + "WHERE contact_id = " + contact.getContact_id() + "";
        }
